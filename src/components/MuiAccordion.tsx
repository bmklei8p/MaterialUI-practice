  ...
  return (
    <div>
        <Accordion expanded={expanded === 'panel1'} onChange={(event, isExpanded) => handleChange(isExpanded, 'panel1')}>
            ...
            <AccordionDetails>
                <Typography>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi dicta distinctio maxime. Inventore molestiae facere dolore placeat laborum adipisci corrupti commodi voluptatibus impedit sequi, sunt earum tempore consequuntur nobis recusandae.
                </Typography>
            </AccordionDetails>
        </Accordion>
